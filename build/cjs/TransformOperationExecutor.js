...
const reflect_metadata_1 = require("reflect-metadata");
            ...
            for (const key of keys) {
                ...
                if (targetType && isMap) {
                    ...
                    if (metadata) {
                        ...
                        const reflectedType = reflect_metadata_1.Reflect.getMetadata('design:type', targetType.prototype, propertyName);
                        if (reflectedType) {
                            type = reflectedType;
                        }
                    }
