...
System.register("class-transformer/TransformOperationExecutor", ["reflect-metadata", "class-transformer/storage"], function (exports_9, context_9) {
    "use strict";
    var reflect_metadata_1, storage_1, TransformationType, TransformOperationExecutor;
    ...
    return {
        setters: [
            function (reflect_metadata_1_1) {
                reflect_metadata_1 = reflect_metadata_1_1;
            },
                        ...
                        var _loop_1 = function (key) {
                            ...
                            if (targetType && isMap) {
                                ...
                                if (metadata_1) {
                                    ...
                                    var reflectedType = reflect_metadata_1.Reflect.getMetadata("design:type", targetType.prototype, propertyName);
                                    if (reflectedType) {
                                        type = reflectedType;
                                    }
                                }
...
System.register("class-transformer/decorators", ["reflect-metadata", "class-transformer/ClassTransformer", "class-transformer/storage", "class-transformer/metadata/TypeMetadata", "class-transformer/metadata/ExposeMetadata", "class-transformer/metadata/ExcludeMetadata", "class-transformer/metadata/TransformMetadata"], function (exports_11, context_11) {
    "use strict";
    var reflect_metadata_2, ClassTransformer_1, storage_2, TypeMetadata_1, ExposeMetadata_1, ExcludeMetadata_1, TransformMetadata_1;
    ...
    function Type(typeFunction, options) {
        return function (target, key) {
            var type = reflect_metadata_2.Reflect.getMetadata("design:type", target, key);
    ...
    return {
        setters: [
            function (reflect_metadata_2_1) {
                reflect_metadata_2 = reflect_metadata_2_1;
            },
