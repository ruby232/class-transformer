...
describe("basic functionality", function () {
    it("should return true if Buffer is present in environment, else false", function () {
        chai_1.expect(TransformOperationExecutor_1.testForBuffer()).to.be.true;
        var bufferImp = global.Buffer;
        delete global.Buffer;
        chai_1.expect(TransformOperationExecutor_1.testForBuffer()).to.be.false;
    ...
    it("should exclude extraneous values if the excludeExtraneousValues option is set to true", function () {
        storage_1.defaultMetadataStorage.clear();
        var User = /** @class */ (function () {
            function User() {
            }
        ...
        var transformedUserWithoutExtra = index_1.plainToClass(User, fromPlainUser, { excludeExtraneousValues: true });
    ...
    it("should convert values to specific types if they are set via @Type decorator", function () {
        ...
        var User = /** @class */ (function () {
            ...
            __decorate([
                decorators_1.Type(function (type) { return Buffer; }),
                __metadata("design:type", Buffer)
            ], User.prototype, "uuidBuffer", void 0);
            __decorate([
                decorators_1.Type(function (type) { return String; }),
                __metadata("design:type", String)
            ], User.prototype, "nullableString", void 0);
            __decorate([
                decorators_1.Type(function (type) { return Number; }),
                __metadata("design:type", Number)
            ], User.prototype, "nullableNumber", void 0);
            __decorate([
                decorators_1.Type(function (type) { return Boolean; }),
                __metadata("design:type", Boolean)
            ], User.prototype, "nullableBoolean", void 0);
            __decorate([
                decorators_1.Type(function (type) { return Date; }),
                __metadata("design:type", Date)
            ], User.prototype, "nullableDate", void 0);
            __decorate([
                decorators_1.Type(function (type) { return Buffer; }),
                __metadata("design:type", Buffer)
            ], User.prototype, "nullableBuffer", void 0);
            return User;
        }());
        var date = new Date();
        var user = new User();
        var uuid = Buffer.from('1234');
        user.firstName = 321;
        user.lastName = 123;
        user.password = "123";
        user.isActive = "1";
        ...
        user.uuidBuffer = uuid;
        user.nullableString = null;
        user.nullableNumber = null;
        user.nullableBoolean = null;
        user.nullableDate = null;
        user.nullableBuffer = null;
        var fromPlainUser = {
            firstName: 321,
            lastName: 123,
            password: "123",
    ...
    it("should transform array", function () {
        storage_1.defaultMetadataStorage.clear();
        var User = /** @class */ (function () {
            function User() {
            }
    ...
    it("should transform objects with null prototype", function () {
        ...
        obj.a = "JS FTW";
        var transformedClass = index_1.plainToClass(TestClass, obj);
        transformedClass.should.be.instanceOf(TestClass);
    });
    it("should default union types where the plain type is an array to an array result", function () {
        var User = /** @class */ (function () {
            function User() {
            }
            return User;
        ...
        var TestClass = /** @class */ (function () {
            ...
            __decorate([
                decorators_1.Type(function () { return User; }),
                __metadata("design:type", Array)
            ], TestClass.prototype, "usersDefined", void 0);
            __decorate([
                decorators_1.Type(function () { return User; }),
                __metadata("design:type", Array)
            ], TestClass.prototype, "usersUndefined", void 0);
            return TestClass;
        }());
        var obj = Object.create(null);
        ...
        chai_1.expect(transformedClass.usersUndefined).to.equal(undefined);
    });
});
